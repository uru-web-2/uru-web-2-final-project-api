...
import {
    ...
    CREATE_GET_ALL_USERS_FN, CREATE_GET_DOCUMENT_AUTHORS_BY_DOCUMENT_ID_FN,
...
import {
    CREATE_ASSIGN_ARTICLE_JURY_MEMBER_PROC,
    ...
    CREATE_DELETE_BOOK_COPY_LOAN_PROC,
    ...
    CREATE_SET_BOOK_COPY_AS_LOST_PROC, CREATE_SET_BOOK_COPY_LOAN_AS_LOST_PROC
...
export default async function migrate() {
    ...
    await DatabaseManager.runTransaction(async (client) => {
        for (const query of [
            ...
            CREATE_GET_DOCUMENT_LANGUAGES_BY_DOCUMENT_ID_FN,
            CREATE_GET_DOCUMENT_TOPICS_BY_DOCUMENT_ID_FN,
            CREATE_GET_DOCUMENT_AUTHORS_BY_DOCUMENT_ID_FN
        ])
            await client.rawQuery(query)
    })
