...
import {
    ...
    CREATE_GET_MODULE_ID_BY_NAME_PROC, CREATE_GET_NUMBER_OF_USERS_PROC,
...
export default async function migrate() {
    ...
    await DatabaseManager.runTransaction(async (client) => {
        ...
        for (const query of [CREATE_CREATE_USER_PROC, CREATE_LOG_IN_PROC, CREATE_IS_METHOD_ID_VALID_PROC, CREATE_IS_PROFILE_ID_VALID_PROC,
         CREATE_GET_USER_ID_BY_USERNAME_PROC, CREATE_ASSIGN_USER_PROFILE_PROC,
         CREATE_REVOKE_USER_PROFILE_PROC, CREATE_ASSIGN_PROFILE_PERMISSION_PROC,
         CREATE_REVOKE_PROFILE_PERMISSION_PROC, CREATE_CREATE_PROFILE_PROC,
         CREATE_UPDATE_PROFILE_PROC, CREATE_DELETE_PROFILE_PROC, CREATE_CREATE_MODULE_PROC,
         CREATE_CREATE_OBJECT_PROC, CREATE_CREATE_METHOD_PROC, CREATE_DELETE_ALL_MODULES_PROC,
         CREATE_CREATE_METHOD_WITH_PROFILES_PROC, CREATE_GET_MODULE_ID_BY_NAME_PROC,
         CREATE_GET_OBJECT_ID_BY_NAME_PROC, CREATE_GET_METHOD_ID_BY_NAME_PROC,
