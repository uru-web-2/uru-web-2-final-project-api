...
import {
    CREATE_ASSIGN_DOCUMENT_AUTHOR_PROC,
    CREATE_ASSIGN_DOCUMENT_LANGUAGE_PROC,
    CREATE_ASSIGN_DOCUMENT_LOCATION_SECTION_PROC,
    ...
    CREATE_CREATE_LOCATION_SECTION_PROC, CREATE_CREATE_MAGAZINE_ISSUE_PROC,
    ...
    CREATE_CREATE_PUBLISHER_PROC, CREATE_CREATE_THESIS_PROC,
    ...
    CREATE_DELETE_ALL_MODULES_PROC, CREATE_DELETE_BOOK_COPY_PROC,
    CREATE_DELETE_DOCUMENT_IMAGE_PROC,
    CREATE_DELETE_DOCUMENT_PROC,
    CREATE_DELETE_DOCUMENT_REVIEW_PROC,
    CREATE_DELETE_LOCATION_PROC,
    CREATE_DELETE_LOCATION_SECTION_PROC,
    CREATE_DELETE_MAGAZINE_PROC,
    CREATE_DELETE_POST_PROC,
    CREATE_DELETE_PROFILE_PROC,
    CREATE_DELETE_PUBLISHER_PROC,
    CREATE_DELETE_TOPIC_PROC,
    ...
    CREATE_GET_OBJECT_ID_BY_NAME_PROC, CREATE_GET_USER_DETAILS_BY_USER_ID_PROC,
    ...
    CREATE_LOG_IN_PROC,
    CREATE_REMOVE_DOCUMENT_AUTHOR_PROC,
    ...
    CREATE_REVOKE_DOCUMENT_LANGUAGE_PROC,
    ...
    CREATE_UPDATE_LOCATION_SECTION_PROC, CREATE_UPDATE_MAGAZINE_ISSUE_PROC,
    CREATE_UPDATE_MAGAZINE_PROC,
    CREATE_UPDATE_POST_PROC,
    CREATE_UPDATE_PROFILE_PROC,
    CREATE_UPDATE_PUBLISHER_PROC, CREATE_UPDATE_THESIS_PROC,
