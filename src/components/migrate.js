...
import {
    ...
    CREATE_BOOKS,
    CREATE_COUNTRIES,
    CREATE_DOCUMENT_AUTHORS, CREATE_DOCUMENT_IMAGES, CREATE_DOCUMENT_LANGUAGES,
    CREATE_DOCUMENT_LOCATIONS,
    CREATE_DOCUMENT_REVIEWS,
    CREATE_DOCUMENT_TOPICS,
    CREATE_DOCUMENTS,
    CREATE_IDENTITY_DOCUMENTS,
    CREATE_LANGUAGES, CREATE_LOCATION_SECTIONS,
    CREATE_LOCATIONS,
...
import {
    ...
    CREATE_GET_USER_PROFILES_FN, CREATE_SEARCH_PROFILE_BY_NAME_FN, CREATE_SEARCH_USER_BY_USERNAME_FN,
...
export default async function migrate() {
    ...
    await DatabaseManager.runTransaction(async (client) => {
        ...
        CREATE_SEARCH_PROFILE_BY_NAME_FN, CREATE_SEARCH_USER_BY_USERNAME_FN])
            await client.rawQuery(query)

        Logger.info("Functions created")

        // Create the stored procedures
        for (const query of [CREATE_CREATE_USER_PROC, CREATE_LOG_IN_PROC,
            CREATE_IS_METHOD_ID_VALID_PROC,
            CREATE_IS_PROFILE_ID_VALID_PROC,
            CREATE_GET_USER_ID_BY_USERNAME_PROC,
            CREATE_ASSIGN_USER_PROFILE_PROC,
