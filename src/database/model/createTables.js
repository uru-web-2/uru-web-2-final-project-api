import {
    ...
    IDENTITY_DOCUMENTS_REMOVED_BY_USER_ID_FK,
    ...
    PASSPORTS_REMOVED_BY_USER_ID_FK,
...
ALTER TABLE identity_documents DROP CONSTRAINT IF EXISTS ${IDENTITY_DOCUMENTS_REMOVED_BY_USER_ID_FK};
ALTER TABLE identity_documents ADD CONSTRAINT ${IDENTITY_DOCUMENTS_REMOVED_BY_USER_ID_FK} FOREIGN KEY (removed_by_user_id) REFERENCES users(id);
...
ALTER TABLE passports DROP CONSTRAINT IF EXISTS ${PASSPORTS_REMOVED_BY_USER_ID_FK};
ALTER TABLE passports ADD CONSTRAINT ${PASSPORTS_REMOVED_BY_USER_ID_FK} FOREIGN KEY (removed_by_user_id) REFERENCES users(id);
`
...
CREATE UNIQUE INDEX IF NOT EXISTS ${DOCUMENT_IMAGES_UNIQUE_UUID} ON document_images (uuid) WHERE removed_at IS NULL;
`;
...
CREATE UNIQUE INDEX IF NOT EXISTS ${MAGAZINE_ISSUES_UNIQUE_MAGAZINE_ID_ISSUE_NUMBER} ON magazine_issues (magazine_id, issue_number);
`;
